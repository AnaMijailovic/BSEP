...
import com.defencefirst.siemcentar.security.auth.RestAuthenticationEntryPoint;
import com.defencefirst.siemcentar.security.auth.TokenAuthenticationFilter;
 ...
 */
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			 ...
			 */
			.antMatchers("/siem/auth/**").permitAll()
	...
	public void configure(WebSecurity web) {
		...
		web.ignoring().antMatchers("/siem/demo");
		web.ignoring().antMatchers(HttpMethod.POST, "/siem/logs");
		web.ignoring().antMatchers("/siem/demo/item");
