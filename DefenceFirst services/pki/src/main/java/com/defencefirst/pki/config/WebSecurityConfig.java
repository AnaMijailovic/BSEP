...
import com.defencefirst.pki.security.TokenUtils;
import com.defencefirst.pki.security.auth.RestAuthenticationEntryPoint;
import com.defencefirst.pki.security.auth.TokenAuthenticationFilter;
import com.defencefirst.pki.service.CustomUserDetailsService;
 ...
 */
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			 ...
			 */
			.antMatchers("/pki/auth/**").permitAll()
	...
	public void configure(WebSecurity web) {
		...
		web.ignoring().antMatchers(HttpMethod.POST, "/pki/auth/login");
		/*
		...
		// web.ignoring().antMatchers(HttpMethod.GET, "/pki/**");	
		web.ignoring().antMatchers(HttpMethod.GET, "/pki/certificates/{serialNumber}/isRevoked");
		// web.ignoring().antMatchers(HttpMethod.GET, "/pki/certificates/**");
		// web.ignoring().antMatchers(HttpMethod.POST, "/pki/*");
		// web.ignoring().antMatchers(HttpMethod.PUT, "/pki/certificates/**");
	}
